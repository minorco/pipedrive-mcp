...
const tools: ToolDefinition[] = [
  ...
  { name: "pipedrive_mail_thread_messages_list", description: "List messages within a mail thread. Use include_body for full content. To fetch a message's attachments, call pipedrive_files_list with the same entity ID plus mail_message_id.", inputSchema: zodToJsonSchema(MailThreadMessagesListSchema), handler: handleMailThreadMessagesList },
