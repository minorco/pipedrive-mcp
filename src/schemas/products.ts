...
export const ProductsCreateSchema = z.object({
  ...
  tax: MoneySchema.optional().describe("Tax percentage"),
  owner_id: OwnerIdSchema,
  prices: z.array(z.object({
    price: MoneySchema,
    currency: z.string(),
    cost: MoneySchema.optional(),
    direct_cost: MoneySchema.optional(),
...
export const DealProductsAddSchema = z.object({
  ...
  item_price: MoneySchema.describe("Price per unit"),
  quantity: QuantitySchema.describe("Quantity"),
...
export const DealProductsUpdateSchema = z.object({
  ...
  item_price: MoneySchema.optional(),
